#!/bin/bash
# Merges settings/settings.prevent-destructive.json from this layer into the project's .claude/settings.json
...
SOURCE_SETTINGS="$LAYER_DIR/settings/settings.prevent-destructive.json"
